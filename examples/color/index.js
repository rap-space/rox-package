...
const Palette = (props) => {
  ...
  return (
    <View>
      {description && (
        <Text style={Object.assign(textStyle, { marginBottom: 8, marginTop: 0 })}>{description}</Text>
      )}
      <View style={style}>
    ...
    return (
      ...
      >
        <Page title="颜色 Color">
          ...
          <View style={styles.btnWithMargin}>
            <Palette token="N1_6" color={Core['color-line1-1']} description="常规" darkText />
            <Palette token="N1_7" color={Core['color-line1-2']} description="深" darkText />
            <Palette token="N1_8" color={Core['color-line1-3']} description="重" darkText />
          </View>
          <Page.Intro main="中立色 - 填充" />
          <View style={styles.btnWithMargin}>
            <Palette token="N1_2" color={Core['color-fill1-1']} description="浅" darkText />
            <Palette token="N1_3" color={Core['color-fill1-2']} description="常规" darkText />
